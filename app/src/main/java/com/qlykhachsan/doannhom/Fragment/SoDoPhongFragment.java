...
public class SoDoPhongFragment extends Fragment implements ItemRoomAdapter.IClickItemRooms, View.OnClickListener {
        ...
        if (status == 0) {
            ...
            new AlertDialog.Builder(getContext())
                    ...
                    .setMessage("Phòng hiện đã đặt bởi " + name + " từ "
                            + sdf.format(obj.getCheckIn()) + " đến "
                            + sdf.format(obj.getCheckOut()))
    ...
    public void onClick(View v) {
        ...
        if(id == R.id.fragSoDoPhong_tv_checkIn) {
        ...
        else if(id == R.id.fragSoDoPhong_tv_checkOut) {
        ...
        else if(id == R.id.fragSoDoPhong_img_currentCategory) {
        ...
        else if(id == R.id.fragSoDoPhong_tv_singleRoom) {
        ...
        else if(id == R.id.fragSoDoPhong_tv_doubleRoom) {
